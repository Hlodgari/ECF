...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 06 fév. 2025 à 09:45
...
INSERT INTO `images` (`id_image`, `chemin_image`, `description_image`, `id_pizza`) VALUES
(1, 'img/mergherita.jpg', 'mergherita', 1),
(2, 'img/reine.jpg', 'reine', 2),
(3, 'img/orientale.jpg', 'orientale', 4),
(4, 'img/pepperoni.jpg', 'pepperoni', 5),
(5, 'img/chevre miel.jpg', 'chevre miel', 6),
(6, 'img/4 fromages.jpg', '4 fromages', 7),
(7, 'img/raclette.jpg', 'raclette', 8),
(8, 'img/savoyarde.jpg', 'savoyarde', 9),
(9, 'img/campagnarde.jpg', 'campagnarde', 10),
(10, 'img/forestiere.jpg', 'forestiere', 11);
...
--
ALTER TABLE `images`
  ADD CONSTRAINT `images_ibfk_1` FOREIGN KEY (`id_pizza`) REFERENCES `pizza` (`id_pizza`);
